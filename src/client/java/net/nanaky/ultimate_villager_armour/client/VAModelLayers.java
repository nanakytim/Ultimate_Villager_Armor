...
import net.nanaky.ultimate_villager_armour.client.models.VillagerArmourModel;
...
public final class VAModelLayers {
        public static final ModelLayerLocation VILLAGER_ELYTRA =
                new ModelLayerLocation(Identifier.fromNamespaceAndPath("ultimate_villager_armour", "elytra"), "main");
        public static final ModelLayerLocation VILLAGER_ARMOR_HEAD =
                new ModelLayerLocation(Identifier.fromNamespaceAndPath("ultimate_villager_armour", "villager"), "armor_head");
        public static final ModelLayerLocation VILLAGER_ARMOR_CHEST =
                new ModelLayerLocation(Identifier.fromNamespaceAndPath("ultimate_villager_armour", "villager"), "armor_chest");
        public static final ModelLayerLocation VILLAGER_ARMOR_LEGS =
                new ModelLayerLocation(Identifier.fromNamespaceAndPath("ultimate_villager_armour", "villager"), "armor_legs");
        public static final ModelLayerLocation VILLAGER_ARMOR_FEET =
                new ModelLayerLocation(Identifier.fromNamespaceAndPath("ultimate_villager_armour", "villager"), "armor_feet");
        public static final ModelLayerLocation ZOMBIE_VILLAGER_ELYTRA =
        new ModelLayerLocation(Identifier.fromNamespaceAndPath("ultimate_villager_armour", "zombie_villager"), "elytra");
        public static final ModelLayerLocation ZOMBIE_VILLAGER_ARMOR_HEAD =
                new ModelLayerLocation(Identifier.fromNamespaceAndPath("ultimate_villager_armour", "zombie_villager"), "armor_head");
        public static final ModelLayerLocation ZOMBIE_VILLAGER_ARMOR_CHEST =
                new ModelLayerLocation(Identifier.fromNamespaceAndPath("ultimate_villager_armour", "zombie_villager"), "armor_chest");
        public static final ModelLayerLocation ZOMBIE_VILLAGER_ARMOR_LEGS =
                new ModelLayerLocation(Identifier.fromNamespaceAndPath("ultimate_villager_armour", "zombie_villager"), "armor_legs");
        public static final ModelLayerLocation ZOMBIE_VILLAGER_ARMOR_FEET =
                new ModelLayerLocation(Identifier.fromNamespaceAndPath("ultimate_villager_armour", "zombie_villager"), "armor_feet");

...
public class ZombieVillagerRendererStateMixin implements IHumanoidRenderState {
    ...
    @Unique private boolean val$isBaby;
    ...
    @Override public boolean val$isBaby() { return val$isBaby; }
    ...
    @Override public void val$setIsBaby(boolean v) { val$isBaby = v; }
}